		...
		if  not line_error:
			...
			if check_GSM_ena:
				...
				if list_line_chip_ena:
					...
					if error_in_exp:
						path_outdir_experiment = os.path.join( path_outdir_error, proposed_name_experiment)
						# Create outdir
					...
					# If there is no error in the experiment
						...
						path_outdir_experiment = os.path.join( path_outdir, proposed_name_experiment)

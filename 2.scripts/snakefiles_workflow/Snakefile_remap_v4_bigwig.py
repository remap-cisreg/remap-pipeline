...
PEAKCALLING_ALT_DIR = "6.1.peakcalling"
BIGWIG_DIR = config["working_dir"]["bigwig_dir"]
BAM_DIR = config["working_dir"]["bam_dir"]
BAM_MERGE_DIR = "5.1.bam_merge"
...
include: os.path.join(BASE_DIR, RULE_DIR, "macs2_bigwig.rules")
include: os.path.join(BASE_DIR, RULE_DIR, "removing_weird_chromosome.rules")
include: os.path.join(BASE_DIR, RULE_DIR, "sort_bedgraph.rules")
include: os.path.join(BASE_DIR, RULE_DIR, "clipping_bedgraph.rules")
include: os.path.join(BASE_DIR, RULE_DIR, "bedgraph_to_bigwig.rules")
